...
// frappe.query_reports["Monthly Current month Vs Last month"] = {
//     "filters": [
//         {
//             "fieldname": "company",
//             "label": __("Company"),
...
//         if (["this_month", "last_month", "variance"].includes(column.fieldname)) {
//             const numValue = parseFloat(data[column.fieldname]);
            
//             if (!isNaN(numValue)) {
//                 value = $(`<span>${format_currency(Math.abs(numValue))}</span>`);
                
//                 if (numValue < 0) {
//                     value = $(value).addClass('text-danger');
//                 }

//                 // Special styling for group rows
//                 if (data.is_group) {
...
//         // Style for achievement percentage
//         if (column.fieldname == "achievement") {
//             const numValue = parseFloat(data.achievement);
            
//             if (!isNaN(numValue)) {
//                 value = $(`<span>${numValue.toFixed(1)}%</span>`);
...
frappe.query_reports["Monthly Current month Vs Last month"] = $.extend({}, management_reports_app.monthly_actual_vs_budget);



// frappe.query_reports["Monthly Actual Vs Budget"]["filters"].push({
